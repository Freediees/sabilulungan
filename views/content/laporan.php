...
<div role="main" class="content-main" style="margin:120px 0 50px">
        ...
        <div class="primary">
            ...
            <div class="project-detail-wrapper">
                <?php
                $Qjudul = $this->db->query("SELECT judul FROM proposal WHERE id='$dx'"); $judul = $Qjudul->result_object();

                $Qlpj = $this->db->query("SELECT `path`, type FROM proposal_lpj WHERE proposal_id='$dx' ORDER BY sequence ASC");
                ?>
                ...
                <div class="gallery-list-wrapper">
                    <ul class="gallery-list list-nostyle clearfix">
                        <?php
                        $j = 0;
                        foreach($Qlpj->result_object() as $lpj){
                            if($lpj->type==1) echo '
                                <li>
