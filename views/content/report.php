    ...
    <div class="wrapper">
        ...
        <div class="form-global">
            <div class="control-group">
				<div>
					<?php
						if($_SESSION['sabilulungan']['role']==1){
						echo '<a class="btn-red btn-plain btn" href="'.site_url('tapd/generate').'">Lihat data TAPD</a>';
						echo '<a class="control-label" href="'.site_url('tapd/generate').'">.</a></br>';
						}
					?>
				</div>
