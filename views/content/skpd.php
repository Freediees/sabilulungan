...
<div role="main" class="content-main" style="margin:120px 0 50px">
    <div class="wrapper-half">
        ...
        <form action="<?php echo base_url('process/skpd/periksa/'.$dx) ?>" method="post" class="form-check form-global">
			...
			<div class="col-wrapper clearfix">
                ...
                <h3 style="color:#ec7404">Besar Rekomendasi Dana</h3>
                    <div class="controls" >
                        <input id="besar" type="text" placeholder="Rp" name="besar">
                    </div>
                </div>
            </div>
...
<div role="main" class="content-main" style="margin:120px 0 50px">
    <div class="wrapper-half">
        ...
        <form action="<?php echo base_url('process/skpd/edit/'.$dx) ?>" method="post" class="form-check form-global">
            <h1 class="page-title page-title-border">Pemeriksaan Proposal Hibah Bansos Hasil Seleksi Pertimbangan</h1>
            <p class="label">Nama (Individu atau Organisasi)</p>
            <p><?php echo $detail[0]->name ?></p>
            <p class="label">Judul Kegiatan</p>
