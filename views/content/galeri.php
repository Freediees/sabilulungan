...
<div role="main" class="content-main" style="margin:120px 0 50px">
        ...
        <div class="primary">
            ...
            <div class="project-detail-wrapper">
                <?php
                $Qjudul = $this->db->query("SELECT judul, foto FROM proposal WHERE id='$dx'"); $judul = $Qjudul->result_object();

                $Qgaleri = $this->db->query("SELECT `path` FROM proposal_photo WHERE proposal_id='$dx' ORDER BY sequence ASC"); $galeri = $Qgaleri->result_object();            
                ?>
                ...
                <div class="gallery-list-wrapper">
                    <ul class="gallery-list list-nostyle clearfix">
                        ...
                        foreach($Qgaleri->result_object() as $galeri){
                            echo '<li>
