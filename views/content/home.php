...
$Qedit = $this->db->query("SELECT content FROM cms WHERE `page_id`='home' ORDER BY sequence ASC"); $edit = $Qedit->result_object();
?>
...
<div role="main" class="content-main">
    ...
    <section class="section-primary section" style="background: url(<?php echo base_url('media/cms/'.$edit[0]->content) ?>) no-repeat 50% 0;">
        <div class="wrapper clearfix">
			...
			<div class="tagline-intro">
                ...
                <span><a class="btn-white btn" href="<?php echo site_url('proposal') ?>">Lihat proposal hibah bansos yang masuk &raquo;</a></span>
            </div>
   ...
   <!-- <section class="section-secondary section" style="background: url(<?php echo base_url('media/cms/'.$edit[1]->content) ?>) no-repeat 50% 0;">
            ...
            <div id="featured-category-tab-1" class="featured-category-tab-panel clearfix">
                ...
                <div class="featured-category-list-wrapper">
                    <ul class="project-list-wrapper list-nostyle clearfix">
                        <?php
                        $Qlist = $this->db->query("SELECT a.id, a.name AS oleh, a.judul, a.time_entry, b.name, b.role_id, c.name AS skpd, SUM(d.amount) AS mohon
                                                FROM proposal a
    ...
    <section class="quotes section">
        <div class="wrapper">
            <h2>MARI KITA AWASI DAN PANTAU PROGRAM BELANJA HIBAH DAN BANSOS </br>YANG BERSIH DAN TRANSPARAN</h2>
            <p>Transparansi program hibah dan bansos ini mengajak semua untuk menumbuhkan kebersamaan guna kepentingan bersama masa depan Kota Cimahi.</p>
