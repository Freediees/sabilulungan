...
<div role="main" class="content-main" style="margin:120px 0 50px">
    <div class="wrapper-half">
        ...
        <form name="pertimbangan" action="<?php echo base_url('process/pertimbangan/verifikasi/'.$dx) ?>" method="post" class="form-check form-global">
            ...
            <p><?php if(isset($check2[0]->checklist_id)) echo 'Dapat direkomendasikan'; else echo 'Tidak dapat direkomendasikan'; ?></p>
            ...
            <div class="col-wrapper clearfix">
                <h3 style="color:#ec7404">Formulir Verifikasi</h3>
				 <div class="control-group">
                    ...
                    <label class="control-label radio-inline radio">
                        <input type="radio" name="beri" value="11">
                        Ya
                    </label>
                   <label class="control-label radio-inline radio">
                        <input type="radio" name="beri" value="12">
                        Tidak
                    </label>
                </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="koreksi" name="koreksi" <?php if(isset($check[1]->value)) echo ' value="'.$check[1]->value.'" disabled'; ?>>
                    </div>
                </div>
