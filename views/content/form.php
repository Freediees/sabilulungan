...
// $Qedit = $this->db->query("SELECT * FROM ak_pengaturan WHERE `id`='pelanggan'"); 
// $edit = $Qedit->result_object();
?>
...
<div id="ifbox_body">
	...
	<div class="ibody">
		...
		<form action="<?php echo base_url('process/tatausaha/periksa') ?>" method="post" id="iforms_f1" onsubmit="return iForms_s(1)">
		<h2>Detail Pengecekan Dokumen</h2>
            <ul class="category-list list-nostyle">
                ...
                <?php
            	$Qlist1 = $this->db->select("id, name")->from('checklist')->where('role_id', 5)->order_by('sequence', 'ASC')->limit(4)->get();
            ...
            <ul class="category-list list-nostyle">
            	<?php
            	$Qlist2 = $this->db->select("id, name")->from('checklist')->where('role_id', 5)->order_by('sequence', 'ASC')->limit(8,4)->get();
...
<div id="ifbox_body">
	...
	<div class="ibody">
		<div id="iforms_r1" style="text-align:center"></div>
		<form action="<?php echo base_url('process/apps/'.$dx) ?>" method="post" id="iforms_f1" onsubmit="return iForms_s(1)" enctype="multipart/form-data">
...
$Qdetail = $this->db->query("SELECT a.name, a.address, a.judul, a.latar_belakang, a.maksud_tujuan, a.time_entry, SUM(b.amount) AS mohon FROM proposal a JOIN proposal_dana b ON b.proposal_id=a.id WHERE a.id='$dx'"); 
...
$Qedit = $this->db->query("SELECT * FROM ak_pengaturan WHERE `id`='koordinator'"); 
$edit = $Qedit->result_object();
?>
...
<div id="ifbox_body">
	...
	<div class="ibody">
		<div id="iforms_r1" style="text-align:center"></div>
		<form action="<?php echo base_url('process/app/'.$dx) ?>" method="post" id="iforms_f1" onsubmit="return iForms_s(1)" enctype="multipart/form-data">
...
$Qdetail = $this->db->query("SELECT a.*, b.nama AS user, b.telepon, c.nama AS pangkalan, d.nama AS ojeg
							FROM ak_order a
...
<div id="ifbox_body">
	...
	<div class="ibody">
		<div id="iforms_r1" style="text-align:center"></div>
		<form action="<?php echo base_url('process/koordinator/add') ?>" method="post" enctype="multipart/form-data" id="iforms_f1" onsubmit="return iForms_s(1)">
		<table border="0" width="100%" class="list" cellpadding="0" cellspacing="0">
		<tr height="30"><td width="150">Pangkalan</td><td width="10">:</td><td><select name="pangkalan"><option>-- Pilih Pangkalan</option> 
			<?php
			$Qcheck = $this->db->select("pangkalan_id")->from('ak_koordinator')->get();
			$not = array(); 
			foreach($Qcheck->result_object() as $check){ 
				array_push($not, $check->pangkalan_id);
			}

			$Qlist = $this->db->select("pangkalan_id, nama")->from('ak_pangkalan')->where_not_in('pangkalan_id', $not)->order_by('nama', 'ASC')->get();
...
$Qedit = $this->db->query("SELECT * FROM ak_koordinator WHERE `koordinator_id`='$dx'"); 
$edit = $Qedit->result_object();
?>
...
<div id="ifbox_body">
	...
	<div class="ibody">
		<div id="iforms_r1" style="text-align:center"></div>
		<form action="<?php echo base_url('process/koordinator/edit/'.$dx) ?>" method="post" enctype="multipart/form-data" id="iforms_f1" onsubmit="return iForms_s(1)">
		<table border="0" width="100%" class="list" cellpadding="0" cellspacing="0">
		<tr height="30"><td width="150">Pangkalan</td><td width="10">:</td><td><select name="pangkalan"><option>-- Pilih Pangkalan</option> 
			<?php
			$Qcheck = $this->db->select("pangkalan_id")->from('ak_koordinator')->where('pangkalan_id !=', $edit[0]->pangkalan_id)->get();
			$not = array();
			foreach($Qcheck->result_object() as $check){ 
				array_push($not, $check->pangkalan_id);
			}

			if(empty($not)) $Qlist = $this->db->select("pangkalan_id, nama")->from('ak_pangkalan')->order_by('nama', 'ASC')->get();
			else $Qlist = $this->db->select("pangkalan_id, nama")->from('ak_pangkalan')->where_not_in('pangkalan_id', $not)->order_by('nama', 'ASC')->get();
			foreach($Qlist->result_object() as $list){ 
...
$Qdetail = $this->db->query("SELECT a.*, b.nama AS pangkalan FROM ak_koordinator a JOIN ak_pangkalan b ON b.pangkalan_id=a.pangkalan_id WHERE a.`koordinator_id`='$dx'"); 
$detail = $Qdetail->result_object();
?>
...
$Qdetail = $this->db->query("SELECT * FROM ak_pengguna WHERE `pengguna_id`='$dx'"); 
$detail = $Qdetail->result_object();
?>
...
<div id="ifbox_body">
	...
	<div class="ibody">
		<div id="iforms_r1" style="text-align:center"></div>
		<form action="<?php echo base_url('process/pangkalan/add') ?>" method="post" id="iforms_f1" onsubmit="return iForms_s(1)">
		<table border="0" width="100%" class="list" cellpadding="0" cellspacing="0">
		<tr height="30"><td width="150">Nama</td><td width="10">:</td><td><input type="text" name="nama" class="inputbox w330" /></td></tr>
		<tr height="30"><td width="150">Alamat</td><td width="10">:</td><td><input type="text" name="alamat" class="inputbox w330" /></td></tr>
...
$Qedit = $this->db->query("SELECT * FROM ak_pangkalan WHERE `pangkalan_id`='$dx'"); 
$edit = $Qedit->result_object();
?>
...
<div id="ifbox_body">
	...
	<div class="ibody">
		<div id="iforms_r1" style="text-align:center"></div>
		<form action="<?php echo base_url('process/pangkalan/edit/'.$dx) ?>" method="post" id="iforms_f1" onsubmit="return iForms_s(1)">
		<table border="0" width="100%" class="list" cellpadding="0" cellspacing="0">
		<tr height="30"><td width="150">Nama</td><td width="10">:</td><td><input type="text" name="nama" class="inputbox w330" value="<?php echo $edit[0]->nama ?>" /></td></tr>
		<tr height="30"><td width="150">Alamat</td><td width="10">:</td><td><input type="text" name="alamat" class="inputbox w330" value="<?php echo $edit[0]->alamat ?>" /></td></tr>
...
$Qdetail = $this->db->query("SELECT * FROM ak_pangkalan WHERE `pangkalan_id`='$dx'"); 
$detail = $Qdetail->result_object();
?>
...
<div id="ifbox_body">
	...
	<div class="ibody">
		<div id="iforms_r1" style="text-align:center"></div>
		<form action="<?php echo base_url('process/ojeg/add') ?>" method="post" id="iforms_f1" enctype="multipart/form-data" onsubmit="return iForms_s(1)">
		<table border="0" width="100%" class="list" cellpadding="0" cellspacing="0">
		<tr height="30"><td width="150">Pangkalan</td><td width="10">:</td><td><select name="pangkalan"><option>-- Pilih Pangkalan</option> 
			<?php
			$Qlist = $this->db->select("pangkalan_id, nama")->from('ak_pangkalan')->order_by('nama', 'ASC')->get();
			foreach($Qlist->result_object() as $list){ 
				echo '<option value="'.$list->pangkalan_id.'">'.$list->nama.'</option> ';
			}
			?>
...
$Qedit = $this->db->query("SELECT * FROM ak_ojeg WHERE `ojeg_id`='$dx'"); 
$edit = $Qedit->result_object();
?>
...
<div id="ifbox_body">
	...
	<div class="ibody">
		<div id="iforms_r1" style="text-align:center"></div>
		<form action="<?php echo base_url('process/ojeg/edit/'.$dx) ?>" method="post" id="iforms_f1" onsubmit="return iForms_s(1)">
		<table border="0" width="100%" class="list" cellpadding="0" cellspacing="0">
...
$Qdetail = $this->db->query("SELECT a.*, b.nama AS pangkalan FROM ak_ojeg a JOIN ak_pangkalan b ON b.pangkalan_id=a.pangkalan_id WHERE a.`ojeg_id`='$dx'"); 
$detail = $Qdetail->result_object();
?>
...
$Qedit = $this->db->query("SELECT konten FROM ak_pengaturan WHERE `id`='harga'"); 
$edit = $Qedit->result_object();
?>
...
<div id="ifbox_body">
	...
	<div class="ibody">
		<div id="iforms_r1" style="text-align:center"></div>
		<form action="<?php echo base_url('process/harga/edit') ?>" method="post" id="iforms_f1" onsubmit="return iForms_s(1)">
		<table border="0" width="100%" class="list" cellpadding="0" cellspacing="0">
...
$Qedit = $this->db->query("SELECT * FROM ak_admin WHERE `admin_id`='$dx'"); 
$edit = $Qedit->result_object();
?>
...
<div id="ifbox_body">
    ...
    <div class="ibody">
    	<div id="iforms_r1" style="text-align:center"></div>
        <form action="<?php echo base_url('process/admin/profil/'.$dx) ?>" method="post" id="iforms_f1" onsubmit="return iForms_s(1)">
        <table border="0" width="100%" class="list" cellpadding="0" cellspacing="0">
...
$Qedit = $this->db->query("SELECT status, warning FROM ak_pengguna WHERE `pengguna_id`='$dx'"); 
$edit = $Qedit->result_object();
?>
...
<div id="ifbox_body">
	...
	<div class="ibody">
		<div id="iforms_r1" style="text-align:center"></div>
		<form action="<?php echo base_url('process/pengguna/status/'.$dx) ?>" method="post" id="iforms_f1" onsubmit="return iForms_s(1)">
		<table border="0" width="100%" class="list" cellpadding="0" cellspacing="0">
