...
<div role="main" class="content-main" style="margin:120px 0 50px">
    <div class="wrapper-half">
        ...
        ?>        
        <form class="form-global" method="post" action="<?php echo base_url('process/user/login') ?>">
            <fieldset>
                ...
                <div class="control-actions clearfix">
					...
					<a class="btn-black btn-plain btn" href="<?php echo site_url('aktivasi') ?>">Aktivasi</a>
                </div>
            </fieldset>
        </form>
        <!-- form-register -->
