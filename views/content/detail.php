    ...
    <div role="main" class="content-main" style="margin:120px 0 50px">
        ...
        <!-- sidebar -->
            <div class="primary">
                ...
                <?php
                $Qlist = $this->db->query("SELECT a.id, a.judul, a.name, a.address, a.latar_belakang, a.maksud_tujuan, a.file, a.nphd, a.tanggal_lpj, a.time_entry, b.name AS tahap
                                        FROM proposal a
                                        LEFT JOIN flow b ON b.id=a.current_stat
                                        WHERE a.id='$dx'"); $list = $Qlist->result_object();

                $Qtu = $this->db->query("SELECT value FROM proposal_checklist WHERE checklist_id='13' AND proposal_id='$dx'"); $tu = $Qtu->result_object();

                $Qimage = $this->db->query("SELECT `path` FROM proposal_photo WHERE `proposal_id`='$dx' ORDER BY sequence ASC LIMIT 1"); $image = $Qimage->result_object();

                //$Qtahap = $this->db->query("SELECT `flow_id` FROM proposal_approval WHERE `proposal_id`='$dx' ORDER BY flow_id DESC LIMIT 1"); $tahap = $Qtahap->result_object();
                ?>
                <div class="project-detail-wrapper">
                    ...
                    <div class="project-detail-description clearfix">
                        ...
                        <div class="project-detail-right">
                            ...
                            <p><span class="label">Tanggal Kegiatan:</span> <br>
