...
$Qtime = $this->db->query("SELECT time_entry FROM proposal_approval WHERE proposal_id='$dx' AND flow_id BETWEEN 1 AND 7"); 
$time = $Qtime->result_object();
?>
...
<div role="main" class="content-main" style="margin:120px 0 50px">
    <div class="wrapper-half">
        ...
        <form action="<?php echo base_url('process/admin/detail/'.$dx) ?>" method="post" class="form-check form-global">
            <h1 class="page-title page-title-border">Detail Proposal Hibah Bansos</h1>
            <p class="label">Tanggal Proposal Masuk</p>
