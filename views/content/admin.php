...
<div role="main" class="content-main" style="margin:120px 0 50px">
    <div class="wrapper-half">
        ...
        <form class="form-global" method="post" action="<?php echo base_url('process/admin/nphd/'.$dx) ?>" onsubmit="return check(<?php if(isset($besar[0]->value)) echo $besar[0]->value; else echo '0'; ?>)" enctype="multipart/form-data">
            <fieldset>
