        ...
        <nav role="navigation" class="nav-main">
            <ul class="clearfix list-nostyle">
                ...
                if(isset($_SESSION['sabilulungan']['role'])){
                    ...
                    elseif($_SESSION['sabilulungan']['role']==5) echo '<li><a class="link-blue" href="'.site_url('proposal').'">Proposal Hibah / Bansos</a></li><li><a class="link-purple" href="'.site_url('hibah').'">Daftar</a></li><li><a class="link-purple" href="'.site_url('report').'">Pengecekan Berkas</a></li> ';
                    ...
                    elseif($_SESSION['sabilulungan']['role']==9) echo '<li><a class="link-blue" href="'.site_url('proposal').'">Proposal Hibah / Bansos</a></li><li><a class="link-purple" href="'.site_url('report').'">Koreksi</a></li><li><a class="link-purple" href="'.site_url('cms').'">CMS</a></li> ';
                }else echo '
                    <li>
