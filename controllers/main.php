...
class Main extends CI_Controller {
	...
	public function aktivasi()
	{
		// if(isset($_SESSION['sabilulungan'])){
			$this->load->view('template/meta');
			$this->load->view('template/header');
			$this->load->view('content/aktivasi');
			$this->load->view('template/footer');
		// }
		// else $this->load->view('template/login');		
	}
	...
	public function proposal_user($t=0, $tp=0, $d=0, $dx=0, $id=0, $p=0)
	{
		// if(isset($_SESSION['sabilulungan'])){
			$this->load->view('template/meta');
			$this->load->view('template/header');
			$this->load->view('content/proposal_user', array('p' => $p,'t' => $t,'tp' => $tp,'d' => $d,'dx' => $dx,'id' => $id));
			$this->load->view('template/footer');
		// }
		// else $this->load->view('template/login');		
	}
	...
	public function panduan()
	{
		// if(isset($_SESSION['sabilulungan'])){
			$this->load->view('template/meta');
			$this->load->view('template/header');
			$this->load->view('content/panduan');
			$this->load->view('template/footer');
		// }
		// else $this->load->view('template/login');		
	}
	...
	public function hibah($tp='', $dx=0)
	{
		$this->load->view('template/meta');
		$this->load->view('template/header');
		if(isset($_SESSION['sabilulungan']) && $_SESSION['sabilulungan']['role']==6 || $_SESSION['sabilulungan']['role']==7 || $_SESSION['sabilulungan']['role']==5 || $_SESSION['sabilulungan']['role']==9) $this->load->view('content/hibah', array('tp' => $tp,'dx' => $dx));
	...
	public function report2($p=0, $dx=0)
	{
		$this->load->view('template/meta');
		$this->load->view('template/header');
		if(isset($_SESSION['sabilulungan'])) $this->load->view('content/report2', array('p' => $p,'dx' => $dx));
		else $this->load->view('content/login');
		$this->load->view('template/footer');		
	}
	...
	public function tapd($tp='', $p=0, $dx=0)
	{
		$this->load->view('template/meta');
		$this->load->view('template/header');
		if(isset($_SESSION['sabilulungan']) && $_SESSION['sabilulungan']['role']==2 || $_SESSION['sabilulungan']['role']==1 || $_SESSION['sabilulungan']['role']==7 || $_SESSION['sabilulungan']['role']==9) $this->load->view('content/tapd', array(
				'p' => $p,
				'tp' => $tp,
				'dx' => $dx
			));
	...
	public function tapd_walikota($tp='', $p=0, $dx=0)
	{
		$this->load->view('template/meta');
		$this->load->view('template/header');
		if(isset($_SESSION['sabilulungan']) && $_SESSION['sabilulungan']['role']==2 || $_SESSION['sabilulungan']['role']==1 || $_SESSION['sabilulungan']['role']==7 || $_SESSION['sabilulungan']['role']==9) $this->load->view('content/tapd_walikota', array(
				'p' => $p,
				'tp' => $tp,
				'dx' => $dx
			));
